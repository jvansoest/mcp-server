...
@click.option("--json-response", is_flag=True, default=True, help="Enable JSON responses instead of SSE streams",)

def main(port="3000", log_level="INFO", json_response=True) -> int:
    ...
    async def handle_streamable_http(scope: Scope, receive: Receive, send: Send) -> None:
        ...
        message_iter = iter(receive_messages)
